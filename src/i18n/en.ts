...
export const en: Translations = {
  ...
  gameTools: {
    ...
    troopsCalculator: {
      ...
      distributionBear: 'Recommended (1:1:8)',
      distributionStack: 'Stacked (Squad 1 first 1:1:8)',
      distributionEven: 'Even',
      modeFull: 'Full split',
      modePartial: 'Short split (stock limit)',
      modeStackFull: 'Stacked — all squads full',
      modeStackPartial: 'Stacked — later squads short',
      modeEvenFits: 'Even split',
